...
import CategoryModel, { categotyDAO } from "../models/category.model";
import response from "../utils/response";

export default {
  async create(req: IReqUser, res: Response) {
    try {
      await categotyDAO.validate(req.body);
  ...
  async findAll(req: IReqUser, res: Response) {
    ...
    try {
      ...
      response.error(res, error, "Failed find all files");
    }
  },
  ...
  async findOne(req: IReqUser, res: Response) {
    try {
      ...
      response.error(res, error, "Failed find one files");
    }
  },
  ...
  async update(req: IReqUser, res: Response) {
    try {
      ...
      response.error(res, error, "Failed update files");
    }
  },
  ...
  async remove(req: IReqUser, res: Response) {
    try {
      ...
      response.error(res, error, "Failed remove files");
    }
  },
};
